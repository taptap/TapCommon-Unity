...
namespace TapTap.UI
{
    public class TapSDKMessage : MonoBehaviour
    {
        ...
        public static void ShowMessage(string msg, TapSDKMessage.Position position, TapSDKMessage.Time time)
        {

            //Load message prefab from resources folder
            GameObject messagePrefab = Resources.Load("TapSDKMessage") as GameObject;
