...
namespace TapTap.Common
{
    ...
    {
        public static readonly string SDKVersion = "3.29.8-beta.4";
        public static readonly int SDKVersionCode = 32908004;
        ...
        public static void Init(TapConfig config)
        {
            ...
            if (UnityMonobehaviorWrapper.Instance != null)
            {
                UnityMonobehaviorWrapper.Instance.Init();
            }

            platformWrapper?.GetOpenLogCommonParams((int)config.RegionType, InitDuration);
#endif
        }

        private static void InitDuration(string openLogParams)
        {
