...
namespace TapTap.Common {
    public class TapCommon {
        public static readonly string SDKVersion = "3.26.0";
        public static readonly int SDKVersionCode = 32600000;
        ...
        public static void Init(TapConfig config) {
            ...
            TapDuration.Init(config.RegionType == RegionType.CN);
        }
        
        public static void GetDeviceId(Action<string> callback) {
            platformWrapper?.GetDeviceId(callback);
        }

        public static void GetDeviceType(Action<int> callback) {
            platformWrapper?.GetDeviceType(callback);
        }
